...
function emmanuel_job_specific()
    ...
    -- vim.cmd('autocmd FileType elixir setlocal errorformat^=%Wwarning: %m%n%C%.%#%f:%l: %.%#%Z')
end

function _G.open_in_parent()
...
function emmanuel_init()
    ...
    vim.g.glow_binary_path = vim.env.HOME .. "/Downloads/usr/bin"
